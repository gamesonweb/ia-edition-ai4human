import{t as e}from"./shaderStore-C5EQilFW.js";var t=`decalFragmentDeclaration`,n=`#ifdef DECAL
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=f);var p=`shadowsFragmentFunctions`,m=`#ifdef SHADOWS
...
return result;}`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=v);var y=`fogFragmentDeclaration`,b=`#ifdef FOG
...
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=b);var x=`depthPrePass`,S=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=S);var C=`logDepthFragment`,w=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=w);var T=`fogFragment`,E=`#ifdef FOG
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=E);var D=`oitFragment`,O=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
