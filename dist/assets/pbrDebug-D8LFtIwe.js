import{t as e}from"./shaderStore-C5EQilFW.js";import"./logDepthDeclaration-BxmClY46.js";import"./oitFragment-BX93gUQN.js";var t=`pbrFragmentExtraDeclaration`,n=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
return result;}
#endif
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=v);var y=`pbrBlockNormalGeometric`,b=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStoreWGSL[y]||(e.IncludesShadersStoreWGSL[y]=b);var x=`pbrBlockImageProcessing`,S=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
