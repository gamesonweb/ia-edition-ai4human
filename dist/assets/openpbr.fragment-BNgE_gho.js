...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=c);var l=`openpbrConductorReflectance`,u=`#define pbr_inline
...
#endif
outParams.F0=1.0;outParams.F90=1.0;return outParams;}`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=u);var d=`openpbrAmbientOcclusionFunctions`,f=`float compute_specular_occlusion(const float n_dot_v,const float metallic,const float ambient_occlusion,const float roughness)
...
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=f);var p=`openpbrVolumeFunctions`,m=`struct OpenPBRHomogeneousVolume {vec3 extinction_coeff; 
vec3 ss_albedo; 
...
weight_sum.b<1e-5f ? unconvolved_irradiance.b : irradiance_sum.b/weight_sum.b);}`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=m);var h=`openpbrNormalMapFragment`,g=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=g);var _=`openpbrBlockNormalFinal`,v=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=v);var y=`openpbrBaseLayerData`,b=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);float geometry_thickness=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=b);var x=`openpbrCoatLayerData`,S=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=S);var C=`openpbrThinFilmLayerData`,w=`#ifdef THIN_FILM
...
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=w);var T=`openpbrFuzzLayerData`,E=`float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=E);var D=`openpbrAmbientOcclusionData`,O=`vec3 ambient_occlusion=vec3(1.0);float specular_ambient_occlusion=1.0;float coat_specular_ambient_occlusion=1.0;
#ifdef AMBIENT_OCCLUSION
...
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=O);var k=`openpbrBackgroundTransmission`,A=`vec4 slab_translucent_background=vec4(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;e.IncludesShadersStore[k]||(e.IncludesShadersStore[k]=A);var j=`openpbrEnvironmentLighting`,M=`#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
#endif
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=I);var L=`openpbrBlockPrePass`,R=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=R);var z=`openpbrPixelShader`,B=`#define OPENPBR_FRAGMENT_SHADER
...
`;e.ShadersStore[z]||(e.ShadersStore[z]=B);var V={name:z,shader:B};export{V as openpbrPixelShader};