import{t as e}from"./shaderStore-C5EQilFW.js";import"./oitFragment-BAZJAT1j.js";import"./logDepthDeclaration-vPf3RhhZ.js";var t=`pbrFragmentExtraDeclaration`,n=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=g);var _=`pbrBlockNormalGeometric`,v=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=v);var y=`pbrBlockImageProcessing`,b=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
