import{t as e}from"./shaderStore-C5EQilFW.js";var t=`clusteredLightingFunctions`,n=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=n);var r=`decalFragment`,i=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=i);var a=`lightFragment`,o=`#ifdef LIGHT{X}
