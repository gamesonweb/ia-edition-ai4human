import{t as e}from"./shaderStore-C5EQilFW.js";var t=`uvAttributeDeclaration`,n=`#if defined(UV{X}) && !defined(USE_VERTEX_PULLING)
...
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=o);var s=`fogVertexDeclaration`,c=`#ifdef FOG
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=u);var d=`vertexPullingDeclaration`,f=`#ifdef USE_VERTEX_PULLING
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=f);var p=`vertexPullingVertex`,m=`#ifdef USE_VERTEX_PULLING
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=m);var h=`prePassVertex`,g=`#ifdef PREPASS_DEPTH
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=g);var _=`uvVariableDeclaration`,v=`#ifdef MAINUV{X}
#if !defined(UV{X})
...
#endif
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=v);var y=`samplerVertexImplementation`,b=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
